...
[ResultHandle](../docs/reference/results/handles.md).
...
[справочнике](../docs/reference/execution/pagination.md).
...
публичный контракт — в [композиции запросов](../docs/reference/request/composition.md).
...
[контракту batch/pool](../docs/reference/execution/batch-pool.md).
...
[транспортный контракт](../docs/reference/execution/transport.md) описан отдельно.
...
При изменении этой ветки сверяйте [критерий готовности](../docs/reference/execution/continuation-state.md)
и [доставку ошибок и лимиты ожидания](../docs/reference/execution/continuation-await.md).
...
См. [бюджет и deadline](../docs/reference/execution/deadlines.md).
