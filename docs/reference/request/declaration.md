...
[общий внешний срок](../execution/deadlines.md#общий-дедлайн-нескольких-вызовов).
...
[безопасность повторов](../execution/retry.md#безопасность-повторов-без-обязательной-настройки).
...
Полный контракт, пример загрузки и миграция: [внешние URL](../serialization/uri-query.md).
...
## Диагностика RequestContractViolation
