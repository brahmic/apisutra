"""Локальные ссылки и якоря документов текущей дискуссии и планов 028/030."""
...
(ARTIFACTS / "clarification-docs.json").write_text(json.dumps(result, indent=2, ensure_ascii=False) + "\n")
