...
| --- | --- | --- |
| `start/` | Выбор задачи, минимальное чтение, порядок и результат | Полные таблицы API и большой код |
...
| `technical/` | Устройство ядра и причины решений | Самостоятельные публичные правила |
