...
файлу; точные соответствия разделов и якорей заполняются в `moves.md` перед порцией
...
| `guides/operation-inventory.md` | `reference/client/operation-inventory.md`, `reference/client/catalogs.md`, `guides/sdk/coverage.md` | Контракты inventory/catalog отдельно от работы с покрытием SDK. |
...
| `guides/provider-catalogs.md` | `reference/client/catalogs.md`, `guides/sdk/coverage.md` | Read-only catalogs, metadata и runtime meta не смешивать. |
